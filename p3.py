...
lines=list(csv.reader(open('C:/Users/Setu Suyagya/Downloads/Data Sets/weather1.csv','r')))
lines
data=lines.pop(0)
print(data)
print()
...
def classify(instance, tree,default=None): # Instance of Play Tennis with Predicted    
    ...
    if instance[attribute] in tree[attribute].keys(): # Value of the attributs in  set of Tree keys  
        ...
        return default
import pandas as pd
df_new=pd.read_csv('C:/Users/Setu Suyagya/Downloads/Data Sets/weather1.csv')
